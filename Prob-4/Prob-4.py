...
def coffeeProcessor():
    ...
    # added missing " at end of order?
    # added missing )
    quantity = int(input("How many pounds of coffee would you like to order?"))
